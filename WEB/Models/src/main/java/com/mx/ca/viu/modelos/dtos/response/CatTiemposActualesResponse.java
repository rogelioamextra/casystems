 ...
 * @author jbecerril
 */
public class CatTiemposActualesResponse extends GenericResponse implements Serializable {

    @JsonProperty("data")
    Data data;

    public CatTiemposActualesResponse() {
    ...
    public static class Data implements Serializable {
        ...
        @JsonProperty("tieposActuales")
        private List<CatTiemposEmpleoActual> lista;

        public List<CatTiemposEmpleoActual> getLista() {
            return lista;
        }

        public void setLista(List<CatTiemposEmpleoActual> lista) {
            this.lista = lista;
        }
