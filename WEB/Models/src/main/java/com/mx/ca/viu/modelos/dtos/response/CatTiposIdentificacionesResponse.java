 ...
 * @author jbecerril
 */
public class CatTiposIdentificacionesResponse extends GenericResponse implements Serializable {

    @JsonProperty("data")
    Data data;

    public CatTiposIdentificacionesResponse() {
    ...
    public static class Data implements Serializable {
        ...
        @JsonProperty("identificaciones")
        private List<CatIdentificaciones> lista;

        public List<CatIdentificaciones> getLista() {
            return lista;
        }

        public void setLista(List<CatIdentificaciones> lista) {
            this.lista = lista;
        }
