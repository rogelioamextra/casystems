...
@ListenerFor(sourceClass = IcarusMenu.class, systemEventClass = PostAddToViewEvent.class)
public class IcarusMenu extends AbstractMenu implements Widget,ComponentSystemEventListener {

    public static final String COMPONENT_TYPE = "org.primefaces.component.IcarusMenu";
    public static final String COMPONENT_FAMILY = "org.primefaces.component";
    private static final String DEFAULT_RENDERER = "org.primefaces.component.IcarusMenuRenderer";
