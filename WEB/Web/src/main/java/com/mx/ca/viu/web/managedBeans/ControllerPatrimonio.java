 ...
 * @author jbecerril
 */
@ManagedBean(name = "controllerPatrimonio")
@javax.faces.bean.ViewScoped
public class ControllerPatrimonio extends UtilServicios implements Serializable, GenericoCatalogosBeans { 

    private CatPatrimonios nuevo;
    private List<CatPatrimonios> listaNacionalidades;
    private List<CatPatrimonios> filtroNacionalidades;
    private boolean banderaEdicion;

    @PostConstruct
    public void init() {
        listaNacionalidades = genericoService.findAll(CatPatrimonios.class);
    }
    ...
    public void editar() {
        if (genericoService.update(nuevo)) {
            ...
            init();
            getAdministradorPaginas().setPagina("catalogos/patrimonios/bandeja.xhtml");
        } else {
    ...
    public void cambiaPaginaEdicion(Object obj) {
        nuevo = (CatPatrimonios) obj;
        banderaEdicion = true;
        getAdministradorPaginas().setPagina("catalogos/patrimonios/patrimonios.xhtml");
    ...
    public CatPatrimonios getNuevo() {
        return nuevo;
    }

    public void setNuevo(CatPatrimonios nuevo) {
        this.nuevo = nuevo;
    }

    public List<CatPatrimonios> getListaNacionalidades() {
        return listaNacionalidades;
    }

    public void setListaNacionalidades(List<CatPatrimonios> listaNacionalidades) {
        this.listaNacionalidades = listaNacionalidades;
    }

    public List<CatPatrimonios> getFiltroNacionalidades() {
        return filtroNacionalidades;
    }

    public void setFiltroNacionalidades(List<CatPatrimonios> filtroNacionalidades) {
