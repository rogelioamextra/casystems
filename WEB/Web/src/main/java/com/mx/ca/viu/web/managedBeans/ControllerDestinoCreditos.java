 ...
 * @author jbecerril
 */
@ManagedBean(name = "controllerDestinoCreditos")
@javax.faces.bean.ViewScoped
public class ControllerDestinoCreditos extends UtilServicios implements Serializable, GenericoCatalogosBeans { 

    private CatDestinoCreditos nuevo;
    private List<CatDestinoCreditos> listaNacionalidades;
    private List<CatDestinoCreditos> filtroNacionalidades;
    private boolean banderaEdicion;

    @PostConstruct
    public void init() {
        listaNacionalidades = genericoService.findAll(CatDestinoCreditos.class);
    }
    ...
    public void editar() {
        if (genericoService.update(nuevo)) {
            ...
            init();
            getAdministradorPaginas().setPagina("catalogos/destinoCredito/bandeja.xhtml");
        } else {
    ...
    public void cambiaPaginaEdicion(Object obj) {
        nuevo = (CatDestinoCreditos) obj;
        banderaEdicion = true;
        getAdministradorPaginas().setPagina("catalogos/destinoCredito/destinoCredito.xhtml");
    ...
    public CatDestinoCreditos getNuevo() {
        return nuevo;
    }

    public void setNuevo(CatDestinoCreditos nuevo) {
        this.nuevo = nuevo;
    }

    public List<CatDestinoCreditos> getListaNacionalidades() {
        return listaNacionalidades;
    }

    public void setListaNacionalidades(List<CatDestinoCreditos> listaNacionalidades) {
        this.listaNacionalidades = listaNacionalidades;
    }

    public List<CatDestinoCreditos> getFiltroNacionalidades() {
        return filtroNacionalidades;
    }

    public void setFiltroNacionalidades(List<CatDestinoCreditos> filtroNacionalidades) {
