 ...
 * @author jbecerril
 */
@ManagedBean(name = "controllerFrecuenciasPago")
@javax.faces.bean.ViewScoped
public class ControllerFrecuenciasPago extends UtilServicios implements Serializable, GenericoCatalogosBeans { 

    private CatFrecuenciaPago nuevo;
    private List<CatFrecuenciaPago> listaNacionalidades;
    private List<CatFrecuenciaPago> filtroNacionalidades;
    private boolean banderaEdicion;

    @PostConstruct
    public void init() {
        listaNacionalidades = genericoService.findAll(CatFrecuenciaPago.class);
    }
    ...
    public void editar() {
        if (genericoService.update(nuevo)) {
            ...
            init();
            getAdministradorPaginas().setPagina("catalogos/frecuencias/bandeja.xhtml");
        } else {
    ...
    public void cambiaPaginaEdicion(Object obj) {
        nuevo = (CatFrecuenciaPago) obj;
        banderaEdicion = true;
        getAdministradorPaginas().setPagina("catalogos/frecuencias/frecuencias.xhtml");
    ...
    public CatFrecuenciaPago getNuevo() {
        return nuevo;
    }

    public void setNuevo(CatFrecuenciaPago nuevo) {
        this.nuevo = nuevo;
    }

    public List<CatFrecuenciaPago> getListaNacionalidades() {
        return listaNacionalidades;
    }

    public void setListaNacionalidades(List<CatFrecuenciaPago> listaNacionalidades) {
        this.listaNacionalidades = listaNacionalidades;
    }

    public List<CatFrecuenciaPago> getFiltroNacionalidades() {
        return filtroNacionalidades;
    }

    public void setFiltroNacionalidades(List<CatFrecuenciaPago> filtroNacionalidades) {
