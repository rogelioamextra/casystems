...
@NamedQueries({
    @NamedQuery(name = "DtEgresos.findAll", query = "SELECT d FROM DtEgresos d"),
    @NamedQuery(name = "DtEgresos.findByIdEgresos", query = "SELECT d FROM DtEgresos d WHERE d.idEgresos = :idEgresos"),
    @NamedQuery(name = "DtEgresos.findByAlimentos", query = "SELECT d FROM DtEgresos d WHERE d.alimentos = :alimentos"),
    @NamedQuery(name = "DtEgresos.findByRenta", query = "SELECT d FROM DtEgresos d WHERE d.renta = :renta"),
    @NamedQuery(name = "DtEgresos.findByGastosEscolares", query = "SELECT d FROM DtEgresos d WHERE d.gastosEscolares = :gastosEscolares"),
    @NamedQuery(name = "DtEgresos.findByTelefono", query = "SELECT d FROM DtEgresos d WHERE d.telefono = :telefono"),
    @NamedQuery(name = "DtEgresos.findByLuz", query = "SELECT d FROM DtEgresos d WHERE d.luz = :luz"),
    @NamedQuery(name = "DtEgresos.findByAgua", query = "SELECT d FROM DtEgresos d WHERE d.agua = :agua"),
    @NamedQuery(name = "DtEgresos.findByGas", query = "SELECT d FROM DtEgresos d WHERE d.gas = :gas"),
    @NamedQuery(name = "DtEgresos.findByTransporteGasolina", query = "SELECT d FROM DtEgresos d WHERE d.transporteGasolina = :transporteGasolina"),
    @NamedQuery(name = "DtEgresos.findByVestido", query = "SELECT d FROM DtEgresos d WHERE d.vestido = :vestido"),
    @NamedQuery(name = "DtEgresos.findByEsparcimiento", query = "SELECT d FROM DtEgresos d WHERE d.esparcimiento = :esparcimiento"),
    @NamedQuery(name = "DtEgresos.findByMantenimientoReparaciones", query = "SELECT d FROM DtEgresos d WHERE d.mantenimientoReparaciones = :mantenimientoReparaciones"),
    @NamedQuery(name = "DtEgresos.findByTotalMensual", query = "SELECT d FROM DtEgresos d WHERE d.totalMensual = :totalMensual")})
