 ...
 * @author jbecerril
 */
public class CatGradoEscolaresResponse extends GenericResponse implements Serializable {

    @JsonProperty("data")
    Data data;

    public CatGradoEscolaresResponse() {
    ...
    public static class Data implements Serializable {
        ...
        @JsonProperty("gradosEscolares")
        private List<CatGradoMaximoEstudios> lista;

        public List<CatGradoMaximoEstudios> getLista() {
            return lista;
        }

        public void setLista(List<CatGradoMaximoEstudios> lista) {
            this.lista = lista;
        }
