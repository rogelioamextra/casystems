 ...
 * @author jbecerril
 */
public class CatTiposViviendasResponse extends GenericResponse implements Serializable {

    @JsonProperty("data")
    Data data;

    public CatTiposViviendasResponse() {
    ...
    public static class Data implements Serializable {
        ...
        @JsonProperty("tiposViviendas")
        private List<CatTiposViviendas> lista;

        public List<CatTiposViviendas> getLista() {
            return lista;
        }

        public void setLista(List<CatTiposViviendas> lista) {
            this.lista = lista;
        }
