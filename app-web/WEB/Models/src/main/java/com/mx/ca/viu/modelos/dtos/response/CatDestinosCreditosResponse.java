 ...
 * @author jbecerril
 */
public class CatDestinosCreditosResponse extends GenericResponse implements Serializable {

    @JsonProperty("data")
    Data data;

    public CatDestinosCreditosResponse() {
    ...
    public static class Data implements Serializable {
        ...
        @JsonProperty("destinosCredito")
        private List<CatDestinoCreditos> lista;

        public List<CatDestinoCreditos> getLista() {
            return lista;
        }

        public void setLista(List<CatDestinoCreditos> lista) {
            this.lista = lista;
        }
