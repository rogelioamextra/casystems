 ...
 * @author jbecerril
 */
public class CatParentescosResponse extends GenericResponse implements Serializable {

    @JsonProperty("data")
    Data data;

    public CatParentescosResponse() {
    ...
    public static class Data implements Serializable {
        ...
        private List<CatParentescos> lista;

        public List<CatParentescos> getLista() {
            return lista;
        }

        public void setLista(List<CatParentescos> lista) {
            this.lista = lista;
        }
