 ...
 * @author jbecerril
 */
public class CatMunicipiosResponse extends GenericResponse implements Serializable {

    @JsonProperty("data")
    Data data;

    public CatMunicipiosResponse() {
    ...
    public static class Data implements Serializable {
        ...
        private List<CatMunicipios> lista;

        public List<CatMunicipios> getLista() {
            return lista;
        }

        public void setLista(List<CatMunicipios> lista) {
            this.lista = lista;
        }
