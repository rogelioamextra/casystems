 ...
 * @author jbecerril
 */
public class CatTiposResidenciasResponse extends GenericResponse implements Serializable {

    @JsonProperty("data")
    Data data;

    public CatTiposResidenciasResponse() {
    ...
    public static class Data implements Serializable {
        ...
        @JsonProperty("tiposResidencias")
        private List<CatTiposResidencias> lista;

        public List<CatTiposResidencias> getLista() {
            return lista;
        }

        public void setLista(List<CatTiposResidencias> lista) {
            this.lista = lista;
        }
