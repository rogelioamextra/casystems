 ...
 * @author jbecerril
 */
@ManagedBean(name = "controllerIdentificaciones")
@javax.faces.bean.ViewScoped
public class ControllerIdentificaciones extends UtilServicios implements Serializable, GenericoCatalogosBeans { 

    private CatIdentificaciones nuevo;
    private List<CatIdentificaciones> listaNacionalidades;
    private List<CatIdentificaciones> filtroNacionalidades;
    private boolean banderaEdicion;

    @PostConstruct
    public void init() {
        listaNacionalidades = genericoService.findAll(CatIdentificaciones.class);
    }
    ...
    public void editar() {
        if (genericoService.update(nuevo)) {
            ...
            init();
            getAdministradorPaginas().setPagina("catalogos/identificaciones/bandeja.xhtml");
        } else {
    ...
    public void cambiaPaginaEdicion(Object obj) {
        nuevo = (CatIdentificaciones) obj;
        banderaEdicion = true;
        getAdministradorPaginas().setPagina("catalogos/identificaciones/identificaciones.xhtml");
    ...
    public CatIdentificaciones getNuevo() {
        return nuevo;
    }

    public void setNuevo(CatIdentificaciones nuevo) {
        this.nuevo = nuevo;
    }

    public List<CatIdentificaciones> getListaNacionalidades() {
        return listaNacionalidades;
    }

    public void setListaNacionalidades(List<CatIdentificaciones> listaNacionalidades) {
        this.listaNacionalidades = listaNacionalidades;
    }

    public List<CatIdentificaciones> getFiltroNacionalidades() {
        return filtroNacionalidades;
    }

    public void setFiltroNacionalidades(List<CatIdentificaciones> filtroNacionalidades) {
